...
namespace SRVTracker
{
    ...
    public partial class FormDrone : Form
    {
        ...
        private void UpdateStatus(string status)
        {
            ...
            {
                textBoxStatus.Text = statusDisplay.ToString();
            });
            if (textBoxStatus.InvokeRequired)
                textBoxStatus.Invoke(action);
            else
                action();
        }
        ...
        private void CheckSpeedAdjustment()
        {
            ...
            else if ((int)FormTracker.SpeedInMS > (double)numericUpDownTargetSpeed.Value)
            {
                _activeKey = Keyboard.DirectXKeyStrokes.DIK_S;
                UpdateStatus("Decelerating");
            }
            else
            {
                SendKey((Keyboard.DirectXKeyStrokes)_activeKey, true);
                _activeKey = null;
        ...
        {
            if (checkBoxSetSpeed.Checked)
                CheckSpeedAdjustment();
        ...
        {
            SendKey(Keyboard.DirectXKeyStrokes.DIK_Q);
        }

        private void buttonW_Click(object sender, EventArgs e)
        {
            SendKey(Keyboard.DirectXKeyStrokes.DIK_W);
        }

        private void buttonE_Click(object sender, EventArgs e)
        {
            SendKey(Keyboard.DirectXKeyStrokes.DIK_E);
        }

        private void buttonA_Click(object sender, EventArgs e)
        {
            SendKey(Keyboard.DirectXKeyStrokes.DIK_A);
        }

        private void buttonS_Click(object sender, EventArgs e)
        {
            SendKey(Keyboard.DirectXKeyStrokes.DIK_S);
        }

        private void buttonD_Click(object sender, EventArgs e)
        {
            SendKey(Keyboard.DirectXKeyStrokes.DIK_D);
        }
        ...
        private void checkBoxSetSpeed_CheckedChanged(object sender, EventArgs e)
        {
